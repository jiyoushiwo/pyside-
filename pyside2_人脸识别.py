...
class Mainwindow(object):
    def __init__(self):
        ...
        self.ui.button1.clicked.connect(self.close)
        self.ui.button.clicked.connect(self.open)
        ...
        self.ui.radioButton_2.clicked.connect(lambda: self.on_radio_button_clicked(self.ui.radioButton2))
